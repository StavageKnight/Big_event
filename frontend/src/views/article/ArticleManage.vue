<template>
  <el-card class="page-container">
    ...
    <el-form inline>
      ...
      <el-form-item>
        <el-button type="primary" @click="articleGet">搜索</el-button>
    ...
    >
      ...
      <el-form :model="articleModel" label-width="100px">
        ...
        <el-form-item>
          ...
          <el-button type="info" @click="add('草稿')">草稿</el-button>
        </el-form-item>
      </el-form>
    </el-drawer>
  </el-card>
...
import { articleList, articleGetList, addArticle } from "@/api/article";
import { ref } from "vue";
...
const uploadSuccess = (res) => {
  ...
  articleModel.value.coverImg = res.message;
};
...
const articleGet = async () => {
  ...
  let res = await articleGetList(parmas);
